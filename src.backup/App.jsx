    ...
    return (
        <div className={`app${menuOpen ? ' menu-is-open' : ''}`}>
            ...
            <section className="hero" id="hero">
                ...
                <div className="container hero-content">
                    ...
                    <h1 className="hero-headline">
                        We don't make videos.<br />We build <em>brands on screen.</em>
                    </h1>
                    <p className="hero-ai-line">Where Human Craft Meets Artificial Intelligence</p>
                    <p className="hero-subtext">
                        Real cameras. AI speed. Cinematic results — for brands that want more than average.
                    </p>
            ...
            <section className="clients-section">
                <div className="container">
                    <div className="clients-header will-animate">
                        <span className="eyebrow">Our Clients</span>
                        <h2 className="section-heading">Brands That Trust Us</h2>
                    </div>
            ...
            <section id="results" className="results-section">
                <div className="container">
                    ...
                    <p className="results-note">Results from our clients, 2023–2025</p>
                </div>
            </section>
            ...
            <section id="about">
                <div className="container">
                    <div className="about-text will-animate">
                        ...
                        <h2 className="section-heading">
                            One team. Full control.<br /><em>No compromises.</em>
                        </h2>
                        <p className="section-subtext">
                    ...
                    <div className="how-we-work will-animate">
                        <div className="hww-card">
                            ...
                            <p className="hww-desc">Real crew, real cameras. We come to you and handle everything in-house — from concept to final cut. No handoffs, no middlemen, no compromises.</p>
                        </div>
                        <div className="hww-card">
                            <div className="hww-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: '28px', height: '28px' }}>
